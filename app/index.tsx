    ...
    <SafeAreaView style={styles.safeArea} edges={['left', 'right', 'bottom']}>
      ...
      <ScrollView style={styles.container} contentContainerStyle={styles.contentContainer}>
        ...
        <View style={styles.header}>
          <Text h1 style={styles.title}>React Native Elements</Text>
        ...
        <Card containerStyle={styles.versionCard}>
          ...
          <View style={styles.versionRow}>
            ...
            <Text style={styles.versionNumber}>5.0.0-beta.1</Text>
          </View>
          <View style={styles.versionRow}>
            <MaterialIcons name="info" size={20} color="#2089dc" />
                ...
                <Link href={component.route as any} asChild>
                  <Pressable style={styles.componentItem}>
                    <View style={styles.componentLeft}>
                      <MaterialIcons name={component.icon as any} size={24} color="#2089dc" />
                      <Text style={styles.componentName}>{component.name}</Text>
                    </View>
                    <MaterialIcons name="chevron-right" size={24} color="#999" />
                  </Pressable>
                </Link>
                {index < components.length - 1 && <Divider style={styles.divider} />}
              </React.Fragment>
            ))}
          </View>
        </Card>
